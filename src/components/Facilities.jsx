    ...
    return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4  md:gap-8  mt-6">
        <div className="col-span-2 grid grid-cols-2 gap-4 lg:gap-8  ">
          ...
          <h2 data-aos="fade-up"  data-aos-duration="2000" className="text-2xl md:text-4xl font-bold mb-5">Our <span className='text-yellow-500'>Focus</span> Is To Provide Best <span className='text-yellow-500'>Education</span> For All Students</h2>
        ...
        <div className="col-span-2">
          <div className="grid grid-cols-2 gap-4 md:gap-8">
            ...
            <div >
              <img data-aos="zoom-in"  data-aos-duration="2000" className='rounded-xl h-[200px] w-full object-cover object-center' src={abc1} alt="" />
             
            </div>
            <div>
              <img data-aos="zoom-in"  data-aos-duration="2000"  className='rounded-xl h-[200px] w-full object-cover object-center' src={abc2} alt="" />
              
            </div>
            <div >
              <img data-aos="zoom-in"  data-aos-duration="2000"  className='rounded-xl h-[200px] w-full object-cover object-center' src={abc3} alt="" />
             
            </div>
            <div >
              <img data-aos="zoom-in"  data-aos-duration="2000"  className='rounded-xl h-[200px] w-full object-cover object-center' src={abc4} alt="" />
